  ...
  describe('getTopPerformingAnnouncements', () => {
      ...
      const mockPerformances = [
        {
          ...
          type: AnnouncementType.EVENT,
          publishedAt: new Date(),
          metrics: { views: 1000, likes: 100, shares: 50, engagementRate: 15 },
        ...
        },
        {
          ...
          type: AnnouncementType.GENERAL,
          publishedAt: new Date(),
          metrics: { views: 500, likes: 50, shares: 25, engagementRate: 10 },
          trends: { daily: {}, weekly: {}, monthly: {} },
          audienceInsights: {
            topDemographics: [],
            engagementByTimeOfDay: {},
    ...
    it('should sort by different metrics', async () => {
      const mockPerformances = [
        {
          id: 'announcement-1',
          metrics: { views: 100, likes: 50, shares: 25, engagementRate: 20 },
        },
        {
          id: 'announcement-2',
          metrics: { views: 200, likes: 30, shares: 40, engagementRate: 15 },
        },
      ] as any;
